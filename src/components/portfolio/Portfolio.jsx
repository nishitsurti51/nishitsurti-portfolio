	...
	return (
		<section className="portfolio container section" id="portfolio">
			...
			<div className="portfolio__filters">
				...
				<span className={activeFilter === 1 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("SIEM"); setActiveFilter(1) }}>
					SIEM
				</span>
				<span className={activeFilter === 2 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("Log Analysis"); setActiveFilter(2) }}>
					Log Analysis
				</span>
				<span className={activeFilter === 3 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("Threat Detection"); setActiveFilter(3) }}>
					Threat Detection
				</span>
				<span className={activeFilter === 4 ? 'portfolio__item portfolio__item-active' : 'portfolio__item'} onClick={() => { filterItems("End-point Security"); setActiveFilter(4) }}>
					End-point Security
				</span>
			</div>
